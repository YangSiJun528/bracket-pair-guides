...
class BracketPairingParityTest : BasePlatformTestCase() {
    fun testDualInterfaceContextualMatcherHasFullAndActiveParity() {
        ...
        val matcher = object : TestBraceMatcher(
    ...
    fun testLayeredLanguagesWithTheSameNumericGroupRemainSeparate() {
        ...
        val leftMatcher = TestBraceMatcher(pairs, groupId = SHARED_GROUP)
        val rightMatcher = TestBraceMatcher(pairs, groupId = SHARED_GROUP)
    ...
    private fun configure(
        ...
        editor.setHighlighter(
            LexerEditorHighlighter(
                CharacterSyntaxHighlighter(tokenFor),
                editor.colorsScheme,
            ),
        )
    }
    ...
    private open class TestBraceMatcher(
    ...
    private class StrictTagMatcher : TestBraceMatcher(
    ...
    private class CharacterSyntaxHighlighter(
        private val tokenFor: (Char) -> IElementType,
    ) : SyntaxHighlighter {
        override fun getHighlightingLexer(): Lexer = CharacterLexer(tokenFor)
