...
class BracketColorPaletteTest : BasePlatformTestCase() {
    fun testExplicitDefaultPaletteDrivesEveryComponentByDefault() {
        ...
        val baseColors =
            (0 until StoredColorFormat.COLOR_COUNT).map { depth ->
    ...
    private fun List<Int>.updated(index: Int, value: Int): List<Int> = toMutableList().also { it[index] = value }
}
