...
internal class ActiveBracketPairIndex private constructor(
    ...
    fun activePairIndex(caretOffset: Int): Int {
    ...
    companion object {
        internal fun build(
            ...
            for (pairIndex in 0 until pairs.size()) {
                ...
                val endExclusive =
                    pairs.closeOffsetAt(pairIndex) + pairs.closeTokenLengthAt(pairIndex)
                val start = pairs.openOffsetAt(pairIndex) + 1
