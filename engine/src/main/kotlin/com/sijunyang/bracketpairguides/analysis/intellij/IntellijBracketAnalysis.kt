...
import com.sijunyang.bracketpairguides.analysis.snapshot.BracketRecognition
...
internal class IntellijBracketAnalysis : BracketAnalysis {
    ...
    override fun analyze(
        ...
        return SnapshotAssembly(
            input = input,
            recognize = {
                documentBrackets.recognize(progress).snapshotRecognition()
            },
            checkCanceled = progress::checkCanceled,
...
private fun DocumentBracketRecognition.snapshotRecognition(): BracketRecognition =
    when (this) {
        is DocumentBracketRecognition.Complete -> BracketRecognition.Complete(pairs)
        is DocumentBracketRecognition.Unavailable -> BracketRecognition.Unavailable(limit)
    }
